...
from account.views import SendPasswordResetEmailView, UserChangePasswordView, UserPasswordResetView, UserRegistrationView,UserLoginView,UserProfileView,AlgorithmView,FindAlgorithmView
urlpatterns = [
